...
if(isset($konfirmasi))
{
  $kode=explode("-",$agenda['kode_agendatendik']);
  ...
  echo form_open('tendik/hapus/'.$agenda['id_agendatendik']);
  echo '<div class="row justify-content-md-center">
  <div class="col">';
  echo form_submit('hapus', 'Hapus!',['class'=>"btn btn-danger"]);
  echo '</div>';

  echo form_hidden($hid=['id'=>$agenda['id_agendatendik']]);
  echo form_close();
  echo '<div class="col">';
  ...
  <main>
    <div class="py-5 text-center">
      ...
      <?php
        ...
        // echo '</div>';
        echo '<div class="col col-md-2">';
        echo '<a type="submit" class="btn btn-primary btn-lg" href="'.site_url('tendikbaru').'">Lapor Aktifitas</a></div>';
        echo '</div>';
        echo '</div>';
     ...
     if(isset($agenda) && !empty($agenda) && !isset($form)){
      ...
      $no_agenda=1;
        ...
        {
          $kode=explode("-",$agenda[$a]['kode_agendatendik']);
          $tgl=substr($kode[1],0,2);
          $bln=BULAN[substr($kode[1],2,2)];
          $thn=substr($kode[1],4,4);
          $tanggal= $tgl." ".$bln." ".$thn;
          ...
          echo '<tr><td><a type="button" class="text-danger" href="'.site_url('tendik/hapus/'.$agenda[$a]['id_agendatendik']).'"><i class="fa-regular fa-calendar-xmark"></i></a>
          <a type="button" class="text-danger" href="'.site_url('tendikedit/'.$agenda[$a]['id_agendatendik']).'"><i class="fa-solid fa-pen-to-square"></i></a></td><td>
