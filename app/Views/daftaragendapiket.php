...
?>
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Agenda Piket <?= $nama_lengkap ?></h2>
      <?php
        ...
        {
          echo 'Belum ada riwayat pelaksanaan tugas piket</p>';
        }
        echo '</p>';
        ...
        // echo '</div>';
        echo '<div class="col col-md-2">';
        echo '<a type="submit" class="btn btn-primary btn-lg" href="'.site_url('piketbaru').'">Lapor</a></div>';
        echo '</div>';
        echo '</div>';
