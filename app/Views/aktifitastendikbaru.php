...
<main>
    ...
    <?php echo form_open('tutasimpan'); ?>
      ...
      if (empty($agenda) && !isset($form)) {
        echo $waktu;
        echo '<p class="lead">Belum ada riwayat aktifitas anda</p>';
        echo '<a type="submit" class="btn btn-primary btn-lg" href="' . site_url('tendik/lapor') . '">Isi Aktifitas</a>';
      }
