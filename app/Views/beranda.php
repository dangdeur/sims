...
<head>
    ...
    <link href="<?= base_url('template/newage/css/styles.css') ?>" rel="stylesheet" />
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                if (auth()->loggedIn()) {
                ?>
                    <a class="btn btn-primary px-3 mb-2 mb-lg-0" href="<?= base_url('logout') ?>">
                        <span class="d-flex align-items-center">
                ...
                ?>
                    <a class="btn btn-primary px-3 mb-2 mb-lg-0" href="<?= base_url('login') ?>">
                        <span class="d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge" src="<?= base_url('template/newage/assets/img/google-play-badge.svg') ?>" alt="..." /></a>
                            <a href="#!"><img class="app-badge" src="<?= base_url('template/newage/assets/img/app-store-badge.svg') ?>" alt="..." /></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="<?= base_url('template/newage/assets/img/tnw-logo.svg') ?>" alt="..." style="height: 3rem" />
                </div>
            </div>
        </div>
    </aside>
